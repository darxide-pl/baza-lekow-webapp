...
<div class="card">
    <div class="action-header palette-Teal-400 bg clearfix">
        ...
        <ul class="ah-actions actions a-alt">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <li>
                        <a href="#" class="btn-action" data-controller="specializations" data-action="filter_every">
                            <?= __('Pokaż leki zawierające wszystkie zaznaczone specjalizacje') ?>    
                        </a>
                    </li>
                    <li>
                        <a href="#" class="btn-action" data-controller="specializations" data-action="filter_any">
                            <?= __('Pokaż leki zawierające dowolną z zaznaczonych specjalizacji') ?>        
                        </a>
                    </li>
                    <li>
                        <a href="#" class="btn-action" data-controller="specializations" data-action="filter_exclude">
                            <?= __('Pokaż leki nie zawierające żadnej z zaznaczonych specjalizacji') ?>    
                        </a>
                    </li>                    
                </ul>
            </li>
    ...
    <div class="list-group lg-alt lg-even-black">
        ...
        <?php if(count($specializations)):foreach($specializations as $v): ?>
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a href="<?= $this->Url->build(['controller' => 'Drugs', 'action' => 'index', '?' => [
	                                	'filter[specializations][]' => $v->id, 
	                                	'filter[specializations_mode]' => 'every'
	                                ]]) ?>">
                                    	<?= __('Pokaż wszystkie leki w tej specjalizacji') ?>	
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <ul class="lgi-attrs">
                            <li>
                                <a href="<?= $this->Url->build(['controller' => 'Drugs', 'action' => 'index', '?' => [
                                    ...
                                    <?= __('Liczba leków w tej specjalizacji: {0}', [$v->drugs]) ?>
                                </a>
                            </li>
                        </ul>
                    </small>
