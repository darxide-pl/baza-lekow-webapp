...
<div class="card">
    <div class="action-header palette-Teal-400 bg clearfix">
        ...
        <ul class="ah-actions actions a-alt">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <li>
                        <a href="#" class="btn-action" data-controller="treatments" data-action="filter_every">
                            <?= __('Pokaż leki zawierające wszystkie zaznaczone działania') ?>    
                        </a>
                    </li>
                    <li>
                        <a href="#" class="btn-action" data-controller="treatments" data-action="filter_any">
                            <?= __('Pokaż leki zawierające dowolne z zaznaczonych działań') ?>        
                        </a>
                    </li>
                    <li>
                        <a href="#" class="btn-action" data-controller="treatments" data-action="filter_exclude">
                            <?= __('Pokaż leki nie zawierające żadnego z zaznaczonych działań') ?>    
                        </a>
                    </li>                    
                </ul>
            </li>
    ...
    <div class="list-group lg-alt lg-even-black">
        ...
        <?php if(count($treatments)):foreach($treatments as $v): ?>
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a href="<?= $this->Url->build(['controller' => 'Drugs', 'action' => 'index', '?' => [
	                                	'filter[treatments][]' => $v->id, 
	                                	'filter[treatments_mode]' => 'every'
	                                ]]) ?>">
                                    	<?= __('Pokaż wszystkie leki o tym działaniu') ?>	
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <ul class="lgi-attrs">
                            <li>
                                <a href="<?= $this->Url->build(['controller' => 'Drugs', 'action' => 'index', '?' => [
                                    ...
                                    <?= __('Liczba leków o takim działaniu: {0}', [$v->drugs]) ?>
                                </a>
                            </li>
                        </ul>
                    </small>
